...
final class AFRICATests: XCTestCase {
    func testEmptyListOfUsers() {
        ...
        XCTAssert(viewModel.id.count == 0)
        XCTAssertTrue(viewModel.name.count == 0)
        XCTAssertEqual(viewModel.headline.count, 0)
    }
